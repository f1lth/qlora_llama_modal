...
stub = modal.Stub("pubmed_lora")

def _train(
    # model/data params
    base_model: str,
    data,
    output_dir: str = "./lora-llama2",
    eval_steps: int = 20,
    save_steps: int = 20,
    ...
    from transformers import LlamaForCausalLM, LlamaTokenizer,AutoTokenizer, AutoModelForCausalLM, TrainingArguments
